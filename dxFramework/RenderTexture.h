...
public:
	...
	bool SetAsActiveTarget(ID3D11DeviceContext * deviceContext, ID3D11DepthStencilView * depthStencilView, bool clearTarget = true, bool clearDepth = false, DirectX::XMFLOAT4 clearColor = { 0.098f, 0.439f, 0.439f, 1.000f });
